...
user = User.create!(email: "info@briisk.co", password: "password", password_confirmation: "password", name: "Biff")
...
Comment.create!(user_id: user.id, movie_id: m2.id, body: "Nunc ac lorem neque. Fusce dignissim ante quis ultricies mattis. Duis et lacus lectus. Etiam rhoncus lacus id sem consectetur, vitae ultrices orci consequat. Nulla a lectus ac lacus euismod hendrerit. In dapibus purus vitae placerat porttitor. Duis ut dolor quis mauris venenatis tempor. Duis molestie, nibh sed porta scelerisque, est massa viverra lorem, ut malesuada mi magna nec quam. Phasellus convallis, lorem ac rutrum elementum, eros leo hendrerit sem.")
...
Comment.create!(user_id: user.id, movie_id: m8.id, body: "Nunc ac lorem neque. Fusce dignissim ante quis ultricies mattis. Duis et lacus lectus. Etiam rhoncus lacus id sem consectetur, vitae ultrices orci consequat. Nulla a lectus ac lacus euismod hendrerit. In dapibus purus vitae placerat porttitor. Duis ut dolor quis mauris venenatis tempor. Duis molestie, nibh sed porta scelerisque, est massa viverra lorem, ut malesuada mi magna nec quam. Phasellus convallis, lorem ac rutrum elementum, eros leo hendrerit sem.")
Comment.create!(user_id: user.id, movie_id: m1.id, body: "Nam luctus eros sed enim ornare, non tempor magna varius. Aenean orci massa, scelerisque sed blandit vel, hendrerit vel tortor. Aliquam erat volutpat. Proin ut justo euismod, sollicitudin mi eu, tristique nunc. Donec pellentesque diam leo, in ornare sapien fermentum ut. Sed quis neque cursus.")
Comment.create!(user_id: user.id, movie_id: m1.id, body: "Cras lacus ligula, tincidunt ac leo eget, dignissim aliquet nisl. Sed at dui dui. Nam sed facilisis odio. Pellentesque tristique massa vitae nibh facilisis tristique. Nullam nunc urna, aliquet ut feugiat non, rhoncus eget lorem. Nunc est enim, gravida id luctus vel, iaculis quis lacus. In volutpat accumsan congue. Nam laoreet dapibus tortor, et mattis ligula accumsan id. In non.")
Comment.create!(user_id: user.id, movie_id: m3.id, body: "Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla sollicitudin felis tempus, posuere lectus eu, interdum enim. Aenean vitae magna dolor. Cras vitae dictum purus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Curabitur sit amet ullamcorper eros, quis vehicula orci.")
Comment.create!(user_id: user.id, movie_id: m2.id, body: "Nunc ac lorem neque. Fusce dignissim ante quis ultricies mattis. Duis et lacus lectus. Etiam rhoncus lacus id sem consectetur, vitae ultrices orci consequat. Nulla a lectus ac lacus euismod hendrerit. In dapibus purus vitae placerat porttitor. Duis ut dolor quis mauris venenatis tempor. Duis molestie, nibh sed porta scelerisque, est massa viverra lorem, ut malesuada mi magna nec quam. Phasellus convallis, lorem ac rutrum elementum, eros leo hendrerit sem.")
Comment.create!(user_id: user.id, movie_id: m9.id, body: "Nunc ac lorem neque. Fusce dignissim ante quis ultricies mattis. Duis et lacus lectus. Etiam rhoncus lacus id sem consectetur, vitae ultrices orci consequat. Nulla a lectus ac lacus euismod hendrerit. In dapibus purus vitae placerat porttitor. Duis ut dolor quis mauris venenatis tempor. Duis molestie, nibh sed porta scelerisque, est massa viverra lorem, ut malesuada mi magna nec quam. Phasellus convallis, lorem ac rutrum elementum, eros leo hendrerit sem.")
Comment.create!(user_id: user.id, movie_id: m10.id, body: "Nunc ac lorem neque. Fusce dignissim ante quis ultricies mattis. Duis et lacus lectus. Etiam rhoncus lacus id sem consectetur, vitae ultrices orci consequat. Nulla a lectus ac lacus euismod hendrerit. In dapibus purus vitae placerat porttitor. Duis ut dolor quis mauris venenatis tempor. Duis molestie, nibh sed porta scelerisque, est massa viverra lorem, ut malesuada mi magna nec quam. Phasellus convallis, lorem ac rutrum elementum, eros leo hendrerit sem.")
